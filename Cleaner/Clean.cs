    ...
    class Clean
    {
        private void TempFiles()
        {
            ...
            if (amountDeleted >= MBSize)
            {
                ...
                Log.Write("cleaner has cleaned " + possibleDeletedFinal + " MB");
            }
            else
            {
                //else just print the amount in KB
                Log.Write("Possible Amount To Delete: " + possibleDeleted + " KB");
            }
            ...
            foreach (string file in files)
            {
                ...
                {
                    Log.Write("Failed to delete '" + file + "' due to file being open");
                }
            }
            ...
            foreach (string directory in directorys)
            {
                ...
                {
                    Log.Write("Failed to delete '" + directory + "' due to folder/files being open");
                }
            }
            ...
            if (amountDeleted >= MBSize)
            {
                ...
                Log.Write("cleaner has cleaned " + amountDeletedFinal + " MB");
            }
            else
            {
                //else print the total deleted in KB
                Log.Write("cleaner has cleaned " + amountDeleted + " KB");
            }
